...
def log(epoch, loss, pred_loss, reg_loss):
    ...
    if args.remote:
        destination = '/home/paulusm/checkpoints/beer_reviews/' + str(args.aspect) + str(args.mode) + str(args.seed) + 'reg' + str(args.reg) + 'reg_mean' + str(args.reg_mean) + 'lr' + str(args.lr) +  'log_marginal.txt'
    else:
        destination = '/Users/Max/checkpoints/beer_reviews/' + str(args.aspect) + str(args.mode) + str(args.seed) + 'reg' + str(args.reg) + 'reg_mean' + str(args.reg_mean) + 'lr' + str(args.lr) +  'log_marginal.txt'
...
def save_checkpoint(state, is_best, filename='marginal_chunk_checkpoint.pth.tar'):
    ...
    """
    if args.remote:
        destination = '/home/paulusm/checkpoints/beer_reviews/' + str(args.aspect) + str(args.mode) + str(args.seed) + 'reg' + str(args.reg) + 'reg_mean' + str(args.reg_mean) + 'lr' + str(args.lr) + 'marginal_ckp.pth.tar'
    else:
        destination = '/Users/Max/checkpoints/beer_reviews/' + str(args.aspect) + str(args.mode) + str(args.seed) + 'reg' + str(args.reg) + 'reg_mean' + str(args.reg_mean) + 'lr' + str(args.lr) +  'marginal_ckp.pth.tar'

    torch.save(state, destination)

    if is_best:
        if args.remote:
            best_destination = '/home/paulusm/checkpoints/beer_reviews/' + str(args.aspect) + str(args.mode) + str(args.seed) + 'reg' + str(args.reg) + 'reg_mean' + str(args.reg_mean) + 'lr' + str(args.lr) + 'marginal_best_ckp.pth.tar'
        else:
            best_destination = '/Users/Max/checkpoints/beer_reviews/' + str(args.aspect) + str(args.mode) + str(args.seed) + 'reg' + str(args.reg) + 'reg_mean' + str(args.reg_mean) + 'lr' + str(args.lr) + 'marginal_best_ckp.pth.tar'
